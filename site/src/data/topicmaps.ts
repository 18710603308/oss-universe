...
export const topicMaps: TopicMap[] = [
  ...
  // ============ 去中心化 / 数据主权谱系 ============
  {
    ...
    icon: '🌐',
    summary:
      '从联邦社交到去中心化存储、自托管应用，一张图看懂"用开放协议与自托管对抗中心化垄断"的开源力量。',
    groups: ['联邦协议', '联邦应用', '去中心化存储', '自托管应用', '隐私工具'],
    nodes: [
      { id: 'activitypub', name: 'ActivityPub', year: 2018, group: '联邦协议', desc: 'W3C 联邦社交协议' },
      { id: 'matrix', name: 'Matrix/Synapse', year: 2014, group: '联邦协议', desc: '去中心化通讯协议', projectId: 'synapse' },
      { id: 'mastodon', name: 'Mastodon', year: 2016, group: '联邦应用', desc: '联邦宇宙社交旗舰', projectId: 'mastodon' },
      { id: 'rocketchat', name: 'Rocket.Chat', year: 2015, group: '联邦应用', desc: '支持 Matrix 联邦', projectId: 'rocketchat' },
      { id: 'jitsi', name: 'Jitsi Meet', year: 2013, group: '联邦应用', desc: '开源视频会议', projectId: 'jitsi' },
      { id: 'ipfs', name: 'IPFS', year: 2015, group: '去中心化存储', desc: '内容寻址存储', projectId: 'ipfs' },
      { id: 'nextcloud', name: 'Nextcloud', year: 2016, group: '自托管应用', desc: '自托管云盘', projectId: 'nextcloud' },
      { id: 'immich', name: 'Immich', year: 2022, group: '自托管应用', desc: '自托管相册', projectId: 'immich' },
      { id: 'jellyfin', name: 'Jellyfin', year: 2018, group: '自托管应用', desc: '自托管影音', projectId: 'jellyfin' },
      { id: 'mattermost', name: 'Mattermost', year: 2015, group: '自托管应用', desc: '自托管团队通讯', projectId: 'mattermost' },
      { id: 'bitwarden', name: 'Bitwarden', year: 2016, group: '隐私工具', desc: '开源密码管理', projectId: 'bitwarden' },
      { id: 'plausible', name: 'Plausible', year: 2019, group: '隐私工具', desc: '隐私友好分析', projectId: 'plausible' },
    ],
    links: [
      { source: 'activitypub', target: 'mastodon', relation: '基于' },
      { source: 'matrix', target: 'rocketchat', relation: '基于' },
      { source: 'mastodon', target: 'jitsi', relation: '启发' },
      { source: 'ipfs', target: 'nextcloud', relation: '竞争' },
      { source: 'nextcloud', target: 'immich', relation: '衍生' },
      { source: 'nextcloud', target: 'jellyfin', relation: '衍生' },
      { source: 'mattermost', target: 'rocketchat', relation: '竞争' },
      { source: 'bitwarden', target: 'plausible', relation: '启发' },
      { source: 'immich', target: 'plausible', relation: '启发' },
    ],
  },
  // ============ 现代终端工具箱 ============
  {
    ...
    icon: '⌨️',
    summary:
      'Rust 重造经典 Unix 命令的浪潮 —— 从 grep/find/cat/ls/cd 到 Shell 与提示符，一套现代化终端体验。',
    groups: ['经典重造', '导航跳转', 'Shell/提示符', '编辑器/复用', '模糊查找'],
    nodes: [
      { id: 'ripgrep', name: 'ripgrep', year: 2016, group: '经典重造', desc: '取代 grep', projectId: 'ripgrep' },
      { id: 'fd', name: 'fd', year: 2017, group: '经典重造', desc: '取代 find', projectId: 'fd' },
      { id: 'bat', name: 'bat', year: 2018, group: '经典重造', desc: '取代 cat', projectId: 'bat' },
      { id: 'eza', name: 'eza', year: 2021, group: '经典重造', desc: '取代 ls', projectId: 'eza' },
      { id: 'zoxide', name: 'zoxide', year: 2020, group: '导航跳转', desc: '智能 cd', projectId: 'zoxide' },
      { id: 'fzf', name: 'fzf', year: 2015, group: '模糊查找', desc: '模糊查找器', projectId: 'fzf' },
      { id: 'starship', name: 'Starship', year: 2019, group: 'Shell/提示符', desc: '跨 Shell 提示符', projectId: 'starship' },
      { id: 'nushell', name: 'Nushell', year: 2019, group: 'Shell/提示符', desc: '结构化数据 Shell', projectId: 'nushell' },
      { id: 'neovim', name: 'Neovim', year: 2014, group: '编辑器/复用', desc: '现代 Vim', projectId: 'neovim' },
      { id: 'tmux', name: 'tmux', year: 2007, group: '编辑器/复用', desc: '终端复用器', projectId: 'tmux' },
    ],
    links: [
      { source: 'ripgrep', target: 'fd', relation: '启发' },
      { source: 'fd', target: 'bat', relation: '衍生' },
      { source: 'bat', target: 'eza', relation: '衍生' },
      { source: 'fzf', target: 'zoxide', relation: '启发' },
      { source: 'ripgrep', target: 'nushell', relation: '启发' },
      { source: 'zoxide', target: 'starship', relation: '基于' },
      { source: 'tmux', target: 'neovim', relation: '基于' },
      { source: 'fzf', target: 'neovim', relation: '基于' },
    ],
  },
];
