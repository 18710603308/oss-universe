...
export const topicMaps: TopicMap[] = [
  // ============ 前端框架族谱 ============
  {
    ...
    nodes: [
      ...
      { id: 'backbone', name: 'Backbone.js', year: 2010, group: '第一代框架', desc: '最早的前端 MVC' },
      { id: 'angularjs', name: 'AngularJS', year: 2010, group: '第一代框架', desc: 'Google 双向绑定框架' },
      { id: 'ember', name: 'Ember.js', year: 2011, group: '第一代框架', desc: '约定优于配置' },
      ...
      { id: 'qwik', name: 'Qwik', year: 2022, group: '编译式新秀', desc: '可恢复性，极致首屏' },
  ...
  // ============ 大数据谱系图 ============
  {
    ...
    nodes: [
      ...
      { id: 'hbase', name: 'HBase', year: 2008, group: '存储', desc: 'Hadoop 上的 NoSQL' },
      { id: 'hive', name: 'Hive', year: 2010, group: '批计算', desc: 'SQL on Hadoop' },
      ...
      { id: 'storm', name: 'Storm', year: 2014, group: '流计算', desc: '早期实时流处理' },
      { id: 'iceberg', name: 'Iceberg', year: 2018, group: '数据湖', desc: '开放表格式' },
    ],
    links: [
  ...
  // ============ 数据库宇宙 ============
  {
    ...
    nodes: [
      ...
      { id: 'cassandra', name: 'Cassandra', year: 2008, group: 'NoSQL', desc: '分布式宽列存储' },
  ...
  // ============ JS 运行时与工具链之争 ============
  {
    ...
    nodes: [
      ...
      { id: 'npm', name: 'npm', year: 2010, group: '包管理', desc: 'JS 包管理标准' },
      { id: 'webpack', name: 'Webpack', year: 2014, group: '打包器', desc: '模块打包器之王' },
      { id: 'ts', name: 'TypeScript', year: 2012, group: '编译/引擎', desc: 'JS 超集', projectId: 'typescript' },
      { id: 'rollup', name: 'Rollup', year: 2015, group: '打包器', desc: 'ESM 打包器' },
  ...
  // ============ 可观测性体系 ============
  {
    ...
    nodes: [
      ...
      { id: 'zipkin', name: 'Zipkin', year: 2012, group: '追踪', desc: 'Twitter 链路追踪' },
      { id: 'grafana', name: 'Grafana', year: 2014, group: '可视化', desc: '可视化仪表盘', projectId: 'grafana' },
      { id: 'elk', name: 'ELK Stack', year: 2010, group: '日志', desc: 'Elasticsearch 日志方案' },
